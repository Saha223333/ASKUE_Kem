object DM: TDM
  ...
  object OTAskueSrc: TOraTable
    ...
    Left = 88
    Top = 16
    object OTAskueSrcID: TFloatField
      FieldName = 'ID'
      Required = True
    end
    object OTAskueSrcNAME: TStringField
      FieldName = 'NAME'
      Size = 100
    end
    object OTAskueSrcEXT_MOD: TStringField
      FieldName = 'EXT_MOD'
      Size = 255
    end
  end
  ...
  object OQRoll: TOraQuery
    ...
    SQL.Strings = (
      ...
      'FROM askue.roll'
      'WHERE askue_src = :id'
      '  AND roll_date = :roll_date --AND id = :roll')
    MasterSource = ODSAskueSrc
    MasterFields = 'id'
    LockMode = lmLockImmediate
    Active = True
    AfterScroll = OQRollAfterScroll
    Left = 88
    Top = 64
    ParamData = <
      item
  ...
  object OQNoCheckPrint: TOraQuery
    ...
    SQL.Strings = (
      ...
      '                           AND bl.DKD >= sysdate)'
      #9#9#9#9#9'   '
      'order by st.NAME_STREET, l.DOM, l.KORP, l.FLAT')
    Active = True
    Left = 88
    Top = 648
    ParamData = <
  ...
  object Update_RMS_PROC: TOraStoredProc
  ...
  object OQNoCheckPrintDefault: TOraQuery
    Session = OS
    SQL.Strings = (
      
        'SELECT distinct u.NAME, st.NAME_STREET, l.DOM || '#39'/'#39' || l.KORP d' +
        'k, l.FLAT,'
      '       l.LS, s.ZAV_NOM, tps.NAME, s.KOMMENT, st.type_street'
      'FROM askue.sch_type_ext ste,'
      '     esbp.schetch s,'
  ...
  object Get_MEDIA_PROC: TOraStoredProc
    StoredProcName = 'askue.GET_MEDIA'
    Session = OS
    SQL.Strings = (
      'begin'
      '  askue.GET_MEDIA(:PDISTRICT);'
      'end;')
    Left = 240
    Top = 176
    ParamData = <
  ...
  object OTAskueDistricts: TOraTable
    TableName = 'ASKUE.DISTRICTS'
    OrderFields = 'id'
    KeyFields = 'id'
    Session = OS
    Active = True
  ...
  object ODSDistricts: TOraDataSource
    DataSet = OTAskueDistricts
    Left = 120
    Top = 256
  end
end
